...
project = u'OIOIOI'
copyright = str(datetime.datetime.now().year) + u', The SIO2 Team'
...
latex_documents = [
    ('index', 'oioioi.tex', u'OIOIOI Documentation', u'SIO2 Team', 'manual'),
]
